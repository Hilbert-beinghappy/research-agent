...
`research-design` contains the v0.2 quantitative and qualitative design plans. `quantitative-synthetic` and `qualitative-synthetic` contain the public v0.3 method-workbench inputs. `manuscripts` contains the two synthetic v0.4 audit exports. Generated project IDs, runtime paths, and local logs are intentionally not committed.
