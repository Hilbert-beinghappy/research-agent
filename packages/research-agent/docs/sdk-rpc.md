...
The package currently reports 2.0.0 while this unpublished hardening tree targets v2.0.1. The canonical research project schema is 1.5.1. A 1.5.0 project opens read-only until its provenance migration is confirmed.
