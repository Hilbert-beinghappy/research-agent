...
const RECORD_SET_PATHS: readonly [RecordKind, string][] = [
	...
	["adapter_export_profile", ".research/records/knowledge/export-profiles"],
	["external_item_link", ".research/records/knowledge/external-links"],
	["monitor_subscription", ".research/records/knowledge/monitor-subscriptions"],
	["monitor_run", ".research/records/knowledge/monitor-runs"],
