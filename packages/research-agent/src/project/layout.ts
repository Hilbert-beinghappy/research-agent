...
const RECORD_SET_PATHS: readonly [RecordKind, string][] = [
	...
	["adapter_registration", ".research/records/plugins/adapters"],
	["exchange_record", ".research/records/exchanges"],
	["collaboration_merge", ".research/records/collaboration/merges"],
	["model_route_decision", ".research/records/model-routes"],
